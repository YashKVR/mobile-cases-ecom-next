...
function Review({imgSrc, className, ...props}: ReviewProps){
    ...
    const POSSIBLE_ANIMATION_DELAYS=["0s", "0.1s", "0.2s", "0.4s", "0.5s"]
...
function ReviewGrid() {
    ...
    const columns: any = splitArray(PHONES, 3)
    const column1 = columns[0]
    const column2 = columns[1]
    const column3: any = splitArray(columns[2], 2)
...
export function Reviews() {
    return <MaxWidthWrapper className="relative max-w-5xl">
        <img aria-hidden="true" src="/what-people-are-buying.png" alt="what people are buying" className="absolute select-none hidden xl:block -left-32 top-1/3" />
